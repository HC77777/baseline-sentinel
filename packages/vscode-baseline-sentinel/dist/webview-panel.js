...
exports.openBaselineSentinelPanel = openBaselineSentinelPanel;
const vscode = __importStar(require("vscode"));
let currentPanel = undefined;
function openBaselineSentinelPanel(context) {
    ...
    currentPanel = vscode.window.createWebviewPanel('baselineSentinel', 'Baseline Sentinel Dashboard', vscode.ViewColumn.One, {
        enableScripts: true,
...
async function sendStatusUpdate(panel) {
    ...
    const hasOpenAIKey = !!config.get('openaiApiKey');
...
async function handleSaveOpenAIKey(apiKey) {
    const config = vscode.workspace.getConfiguration('baseline-sentinel');
